...
async def update_book(book_uid: str, book_update_date: BookUpdateModel, session: AsyncSession = Depends(get_session), user_details = Depends(access_token_bearer)) -> dict:
